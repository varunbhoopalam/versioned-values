...
def cannot_initialize_directory
...
def get_value_of_principle(principle)
...
def add_values_to_principles(principles)
...
def order_principles(principles_and_values)
...
def write_to_disk(principle_hashes)
...
## Init
## Finally write the principle session to disk by creating a directory ./.values and inside values a folder named 1-0 with the appropriate files